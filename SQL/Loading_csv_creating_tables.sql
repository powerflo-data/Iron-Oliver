...
use bank_demo_demo;drop table if exists district_demo;CREATE TABLE district_demo (
...
);drop table if exists account_demo;CREATE TABLE account_demo (
...
(2,'Benesov','central Bohemia',88884,80,26,6,2,5,46.7,8507,1.67,1.85,132,2159,2674),
 ...
 (4,'Kladno','central Bohemia',149893,63,29,6,2,6,67.4,9753,4.64,5.05,109,5244,5892);insert into account_demo values
(1,4,'POPLATEK MESICNE',950324),
(2,1,'POPLATEK MESICNE',930226),
(3,2,'POPLATEK MESICNE',970707);alter table account_demo
modify date date;
select * from account_demo;alter table district_demo
drop column A15;
select * from district_demo;alter table account_demo
rename to account_Demo;alter table district_demo
rename column A1 to dist_id;alter table account_Demo
...
load data local infile 'C:/Users/powerflo/Iron-Oliver/SQL/district.csv' -- this file is at files_for_lesson_and_activities folder
into table district_demo
fields terminated by ',';

delete from account_demo;

load data local infile 'C:/Users/powerflo/Iron-Oliver/SQL/account.csv' -- this file is at files_for_lesson_and_activities folders
